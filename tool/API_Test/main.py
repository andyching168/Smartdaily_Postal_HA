...
def print_disclaimer():
    ...
    print("【 ⚠️  重要免責聲明與安全警告 】")
    print("="*60 + "\033[0m")
    print("1. 本工具僅供【學術研究】與【個人自動化系統測試】使用。")
    print("2. 開發者不對使用本工具所造成的任何帳號異常、資料外洩負責。")
    print("3. 請勿使用本工具存取非您本人授權的帳號或社區資料。")
    print("\n\033[93m【 🔒 資安風險提示 】")
    print("您的 Device ID (或條碼) 等同於您的長期登入憑證。")
    print("擁有此 ID 者可查閱您的：姓名、電話、地址、包裹紀錄。")
    print("請確保您不在公共電腦運行此程式，並在使用後妥善清除紀錄。")
    print("\033[0m" + "="*60)
    
    confirm = input("若您同意上述條款並了解風險，請輸入 'YES' 繼續 (其他鍵退出): ")
